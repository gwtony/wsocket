...
//#define	BUFMIN	1024
//#define	BUFMAX	(BUFMIN*(1<<MAXSHIFT))
...
streambuf_t *streambuf_new(size_t s_limit, size_t h_limit)
{
...
int streambuf_write_wouldblock(streambuf_t *p)
{
	struct streambuf_st *buf=p;
	size_t ret;
